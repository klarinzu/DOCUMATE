<div class="space-y-6">
        ...
        <div class="rounded-[28px] border border-[#d7e0ee] bg-white p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)]">
            ...
            <div class="mt-5 space-y-3 text-sm">
                ...
                <div class="flex items-center justify-between rounded-xl bg-slate-50 px-4 py-3">
                    ...
                    <span class="font-medium text-slate-800">{{ $user->year_level ?: '-' }}</span>
                </div>
    ...
    <section class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            ...
            <div class="mt-6 grid gap-4 md:grid-cols-2">
                ...
                <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                    ...
                    <div class="mt-3 space-y-2 text-sm text-slate-700">
                        ...
                        <p><span class="font-semibold text-slate-900">Year:</span> {{ $user->year_level ?: '-' }}</p>
        ...
        <div class="rounded-[28px] border border-[#d7e0ee] bg-white p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)]">
            <p class="text-xs font-semibold uppercase tracking-[0.24em] text-slate-400">Verification</p>
            <h2 class="mt-2 text-2xl font-extrabold text-slate-900">Enrollment Status</h2>
